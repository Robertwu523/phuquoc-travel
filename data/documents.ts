...
export const checklistGroups: ChecklistGroup[] = [
  {
    ...
    items: [
      ...
      "越南 e-Visa 已出签（提前 3-5 工作日办，evisa.xuatnhapcanh.gov.vn）",
      "e-Visa 打印件（A4 彩色或黑白，随护照携带入境）",
      "往返机票行程单（打印或存手机离线）",
      "酒店预订单（打印或存手机）",
      "护照复印件 / 扫描件（单独存放，丢了补办用）",
      "证件照电子版 + 白底证件照打印（办 e-Visa / 备用）",
      "海关现金申报表（携带 > $5,000 等值需申报）",
    ],
  },
  {
    name: "钱与支付",
    emoji: "💰",
    items: [
      "越南盾现金（多备小面额，小店/夜市/出租车用）",
      "Visa / Mastercard 两张（一主一备，银联覆盖少）",
      "少量港元备用金",
      "手机绑定境外可用支付 / 出发前告知银行出境",
    ],
  },
  {
    name: "健康与安全",
    ...
    items: [
      "旅行保险单 + 紧急救援电话（打印或拍照）",
      "中国驻胡志明市总领馆领事保护 +84-28-39002333",
      "越南紧急电话：报警 113 / 急救 115 / 火警 114",
      "常用药（肠胃 / 感冒 / 晕车 / 创可贴消毒）",
      "防晒 SPF50+ + 防蚊液",
    ],
  },
  {
    ...
    items: [
      "手机 + 充电器 + 移动电源",
      "越南 SIM / eSIM（Viettel / Mobifone，约 100-200k VND）",
      "转换插头（越南 220V · 插座 A / C / D，国标三脚需转换）",
      "数据线 / 耳机",
      "离线地图 + 翻译 App（Google Maps / Google Translate 需翻墙）",
    ],
  },
  {
    name: "交通与自驾",
    emoji: "🛵",
    items: [
      "⚠️ 越南不认国际驾照 IDP——租摩托出事故保险可能拒赔",
      "如租摩托：确认有头盔 + 检查车况 + 拍照留存",
      "Grab / Sun Taxi App 已下载（叫车/摩的）",
      "跨海缆车 / 跳岛船票可现场或提前在线订",
    ],
  },
  {
